...
**Demo:** `bahkobyra.se/goldring/` (källa: `web/app/(demo)/goldring/`)
**Status:** demo byggd 2026-09-17 på golvvision-kanon i alltfix-utförandet (senaste demon 2026-09-14: konturstjärnor på exempelkorten), copy-stomme via andrens (samma nisch). Lån-läget, 0 credits för media. **VARM:** Alexander sa ja till gratis prototyp i IG-DM 2026-09-17 kl 19:26 ("Ja du kan få göra en prototyp gratis"), Mathias lovade prototyp inom 48 h. Mergad till main 2026-09-17. Inkom via Instagram, Mathias skärmdump.
