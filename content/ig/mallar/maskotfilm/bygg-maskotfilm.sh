...
alimiter=level_in=1:level_out=1:limit=0.92,loudnorm=I=-14:TP=-1.5:LRA=11,alimiter=level_in=1:level_out=1:limit=0.84:attack=3:release=40:level=false,aformat=sample_rates=48000:channel_layouts=stereo[aout]" \
