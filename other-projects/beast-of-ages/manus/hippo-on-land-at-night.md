# You Meet a Hippo on Land at Night
...
formuleringar, `vidiq_youtube_search`): noll träffar på vinkeln "varför är flodhästen
farligast på land nattetid". Det som finns är attack-kompilationer (Claws 531 000
prenumeranter, Nat Geo Wilds 46-minuters *When Hippos Attack* 191 007) och 1 Minute
Animals kortfakta (9,4 miljoner, 57 sekunder) — annat format, annan fråga. Steg 3: ingen
kanal i vår storleksklass har gjort den. Steg 4: titeln lånar ingen konkurrents form.
Steg 5: flodhästen är känd, stor och ritbar, och titelns löfte betalas av stig-mekaniken.

---

## Del 1 — Paketet

### Titlarna — nummer 1 är låst (Mathias titel)

#### 1. You Meet a Hippo on Land at Night

**Mall:** LÅST. Mathias egen formulering, andraperson-scenario (mall F). **Bevis:**
vidIQ-titelpoäng 2026-09-09: **86/100**. Den enda titeln som lovar exakt det videon är:
en enda situation, berättad inifrån. De högre poängen nedan lovar varsin delmängd.

#### 2. You Meet a Hippo on Land at Night. Here's What Actually Happens

**Mall:** Samma som 1 med en andra mening. **Bevis:** vidIQ **97/100**, högst av de tio.
Längre än YouTube visar på TV; testa som B-titel.

#### 3. Why a Hippo on Land Is More Dangerous Than a Lion

**Mall:** Jämförelse, kanalens *Why Lions Are Terrified Of Baboons* (11 544). **Bevis:**
vidIQ **95/100**. Risk: manuset säger att bettet är dubbelt ett lejons, men dödssiffran
mot lejon är just den omtvistade 500-siffran manuset plockar isär. Titeln lovar mer än
manuset vill stå för.

#### 4. The Real Reason Hippos Kill People on Land at Night

**Mall:** "The Real Reason", vann hjortpaketet (97). **Bevis:** vidIQ **94/100**. Betalas
av stig-mekaniken i stycke 4.

#### 5. Nothing About the Hippo Makes Sense… Here's Why

**Mall:** Kanalens egen "Nothing About X Makes Sense". **Bevis:** vidIQ **94/100**.
Täcker faktablocket (simmar inte, släkt med valen, blodsvetten) men tappar scenariot.
...
**Mall:** "The One X"-gåta. **Bevis:** vidIQ **93/100**. Miniatyren måste då visa stigen.

#### 8. Hippos Walk Miles Inland Every Night. That's the Problem.

**Mall:** Fakta plus konsekvens, två meningar. **Bevis:** vidIQ **93/100**. Stycke 3 rakt
av.

#### 9. What to Do If a Hippo Blocks Your Path at Night

**Mall:** Överlevnadsråd. **Bevis:** vidIQ **92/100**. Betalas av sista stycket. Risk:
drar mot survival-genren snarare än naturdokumentär.

#### 10. Never Stand Between a Hippo and the Water

**Mall:** Regeln som titel. **Bevis:** vidIQ **89/100**. Avslöjar mekaniken i titeln.

---

### Thumbnail

**Motivet kommer ur manusets höjdpunkt** (regel 16): stigen i mörkret och djuret som inte
går runt dig. Tittaren ska stå där, med ficklampan, och se att vägen hem är blockerad.

**Frågan vi vill väcka:** vad gör man nu?
**Känslan:** stillheten precis före något.
...
```
Photorealistic night scene on a narrow dirt path through dry African bush, shot from a standing person's eye level looking straight down the path, a single handheld flashlight beam from the camera position lighting the scene, and in that beam twenty meters ahead an enormous adult hippopotamus standing squarely on the path facing the camera, completely still, mouth closed, wet skin catching the light, its two eyes reflecting the beam, the hippo filling the lower two-thirds of the frame, dust hanging in the light cone, everything outside the beam falling to near-black, the upper third of the frame plain dark sky with clear empty space reserved for text, no text, no letters, no logos, no people visible, no vehicles, 8k detail
```

**50-procentstestet:** täcker man nedre halvan syns fortfarande texten uppe till vänster
och flodhästens huvud och de två lysande ögonen. Publiken är 45–70 och TV-tung.
...
Another animal whose whole existence was arranged around one job it never chose: Why Does Every De-Extinction Start With a Mouse.
```

### Pinnad kommentar

```
The one rule from this video: never put yourself between a hippo and the water, and if you already are, step sideways, never back down the path. Has anyone here actually met one on land?
```

### CTA — sista partiet i manuset

Pekar på **Why Does Every De-Extinction Start With a Mouse**, kanalens senaste video
(`nUnwiXstoPE`, publicerad 2026-09-05, hämtad via `vidiq_channel_videos` 2026-09-10,
aldrig gissad). Bryggan: flodhästens hela liv är ordnat kring en enda sak (vägen till
vattnet); musens hela existens i laboratoriet är ordnad kring en enda uppgift den aldrig
valde.

```
There is another video on this channel about an animal whose entire existence has been arranged around one job it never chose. It is called Why Does Every De-Extinction Start With a Mouse.
```
...
The family tree turns out to be just as strange. Genetic sequencing has settled a question that puzzled biologists for over a century: the hippo's closest living relative on Earth is the whale. The two lineages split from a shared ancestor somewhere between 50 and 60 million years ago, and the best fossil candidate for a link to that ancestor, a small deer-like animal called Indohyus, looked nothing like modern hippos or whales. Somewhere in that split, one branch went on to lose its legs entirely and never touch land again, while the other kept its legs and never fully left it either.
