...
Skapa en överflödande top of funnel som genererar DM-konversationer → audit → hemsideförsäljning.

## Målgrupp

Bygg & renovering, tak (takläggare), måleri, mark & anläggning. Lokala företag i Sverige.
Budskap: **FOR THEM** — fler jobb/offerter via en sajt som rankar och konverterar.

---

## Cadence (hållbar)

| Format | Frekvens | Syfte |
|--------|----------|-------|
| Reel | 3/vecka | räckvidd, stoppa scrollen, visa kompetens |
| Carousell | 2/vecka | utbilda, bevisa expertis, spara/dela |
| Story | dagligen | top-of-mind, polls, BTS, audit-CTA |
| DM-cadence | löpande | skriven-first (dag 1/3/5/7), se nedan |

Skippa inte dagar. Volym slår perfektion. (Se daglig blast i `workflows/sales_methodology.md`.)
...
När någon svarar på en reel/story/DM:
1. Lägg in som lead i dashboarden, `niche: bygg`, `pathway: skriven`.
2. Kör skriven-first-cadencen (dag 1/3/5/7) — se `workflows/outreach_cadence.md`.
3. Erbjud gratis audit → Loom → boka samtal → sälj hemsida (engångs).

## Self-improvement

Notera vilka hooks/format som ger mest DM/sparningar. Dubbla på det som funkar, dumpa resten.
Uppdatera `.claude/skills/instagram-engine/templates.md` med vinnande vinklar.
