...
Ring **dag 2** (dagen efter Steg 1-mejlet). Bästa tider:
- **Tisdag–torsdag kl 09–11** eller **14–16**
- Undvik: måndag morgon, fredag eftermiddag, lunch (12–13)
...
Avsluta alltid positivt — du vet aldrig när de ringer tillbaka.
...
|-----------|------------|
| Inte nådd | "Ring igen [dag]" |
| Inte intresserad | Markera "forlorad" + anteckning |
| Intresserad, vill ha mer info | "Skickat mejl + demo" |
| Bokat möte | Markera "demo_bokad" |

---

## Mål

- Ring **10 leads/dag** (tar ca 60-90 min inkl prep)
- Mål: 1 bokat möte per 20 samtal (5%)
- Nå 3-4 möten i veckan = heltidsjobb på telefon under 2 veckor

## Spåra resultat

| Vecka | Ringde | Nådde | Intresserade | Möten bokade |
|-------|--------|-------|--------------|--------------|
| V12   |        |       |              |              |
| V13   |        |       |              |              |
