...
(function () {
  ...
  const T = {
    sv: {
      ...
      'event.std.b1':   'Inträde till eventet',
      'event.std.b2':   'Matlagning, berättelser och frågestund',
      'event.std.b3':   'Möjlighet att smaka på maten',
      'event.vip.name': 'VIP',
      'event.vip.note':  'Inkluderar bland annat:',
            'event.vip.b2':   'Signerad kokbok',
      'event.vip.b3':   'Prioriterad sittplats',
      'event.vip.b4':   'Möjlighet att träffa Mayka och ta bilder',
      'event.btn':      'Köp biljett →',
      'event.note':     'Biljetter säljs via Billetto',
      /* SOCIALA KANALER */
      ...
      'collab.i3':  'Matfoto och video',
      'collab.i4':  'Event och matupplevelser',
      'collab.how': 'Skriv ett mejl med vad ni har i tankarna, så återkommer jag med upplägg och pris.',
      /* NAV */
      'nav.home':    'Hem',
      'nav.recipes': 'Recept',
      ...
      'cta.card1.body':  'Autentiskt innehåll som engagerar. Det här jobbar jag med:',
    ...
    en: {
      ...
      'event.currency': 'SEK',
      'event.std.name': 'Standard',
      'event.std.b1':   'Entry to the event',
      'event.std.b2':   'Cooking, stories and a Q&amp;A',
      'event.std.b3':   'The chance to taste the food',
      'event.vip.name': 'VIP',
      'event.vip.note':  'Includes among other things:',
            'event.vip.b2':   'Signed cookbook',
      'event.vip.b3':   'Priority seating',
      'event.vip.b4':   'The chance to meet Mayka and take photos',
      'event.btn':      'Buy ticket →',
      'event.note':     'Tickets are sold via Billetto',
      /* SOCIAL CHANNELS */
      ...
      'collab.i3':  'Food photography and video',
      'collab.i4':  'Events and food experiences',
      'collab.how': 'Send an email describing what you have in mind and I will come back with an approach and a price.',
      /* NAV */
      'nav.home':    'Home',
      'nav.recipes': 'Recipes',
      ...
      'cta.card1.body':  'Authentic content that engages. This is what I work with:',
